...
function familyContent(slide) {
  ...
  switch (slide.family) {
    ...
    case "risks":
      return `
        <h1 class="slide-title">${escapeHtml(slide.title)}</h1>
        <div class="risks risks--count-${content.items.length}" style="--risk-count:${content.items.length}">${content.items
          .map(
            (item, index) => `
...
.stage,.slide{background:#fcfbf8}.metric{min-height:0}.metric:nth-child(2){background:#e5eef7;border-color:#d3e0ec;color:var(--ink)}.metric:nth-child(2) strong,.metric:nth-child(2) small{color:#315f88}.metric:nth-child(2) span{color:var(--muted)}.metric:nth-child(4){background:#e7efe5;border-color:#d5e2d1;color:var(--ink)}.metric:nth-child(4) strong,.metric:nth-child(4) small{color:#476b4d}.metric:nth-child(4) span{color:var(--muted)}.responsibility{display:grid;gap:18px;grid-template-columns:repeat(5,minmax(0,1fr))}.responsibility-step{min-height:0;padding:28px 24px 26px}.responsibility-step--model{background:#e5eef7;border-color:#d3e0ec;color:var(--ink)}.responsibility-step--human{background:#eceef2;border-color:#d9dde4;color:var(--ink)}.responsibility-step--model strong{color:#315f88}.responsibility-step--human strong{color:#4b5563}.responsibility-step p{font-size:18px;font-weight:550;line-height:1.35;margin-top:24px}.responsibility-step--model small,.responsibility-step--human small,.risk--dark small,.evidence-group--dark small{color:#315f88}.flow-arrow{display:none}.authority{background:transparent;border:0;border-top:1px solid #c8d1d8;color:#4b5563;font-size:16px;font-weight:600;margin-top:24px;padding:14px 0 0}.authority small,.stop small{color:#315f88}.risk{background:#f5f7f8;min-height:0;padding:34px 38px}.risk--dark{background:#e8f0ea;border-color:#d8e4da;color:var(--ink)}.risk--dark dt{color:#526b58}.risk--dark dd{color:var(--muted)}.stop{background:transparent;border:0;border-top:1px solid #c8d1d8;color:#4b5563;font-size:16px;font-weight:600;margin-top:22px;padding:14px 0 0}.evidence-group--dark{background:#e8eef3;border-color:#d7e1e8;color:var(--ink)}.evidence-group--dark ul{color:var(--muted)}
.metrics,.responsibility,.risks{border:1px solid #d8e0e7;border-radius:18px;box-shadow:0 14px 34px #1f334814;gap:0;overflow:hidden;position:relative}.metrics:before,.responsibility:before,.risks:before{background:linear-gradient(90deg,#2563eb,#6d5bd0);content:"";height:2px;left:0;position:absolute;right:0;top:0;z-index:1}.metric{border:0;border-right:1px solid #d8e0e7;border-radius:0;padding:36px 32px}.metric:last-child{border-right:0}.responsibility{margin-top:52px}.responsibility-step{border:0;border-right:1px solid #d8e0e7}.responsibility-step:last-child{border-right:0}.risks{background:#f8fafb}.risk{border:0;border-right:1px solid #d8e0e7;border-radius:0}.risk:last-child{border-right:0}
.risks{grid-template-columns:repeat(var(--risk-count),minmax(0,1fr))}.risks--count-1{grid-template-columns:minmax(0,720px);justify-content:center}.risks--count-1 .risk{border-right:0}.risks--count-3 .risk{min-height:0;padding:30px}.risks--count-3 .risk h2{font-size:24px}.risks--count-3 .risk dl{grid-template-columns:84px 1fr;margin-top:26px}.risks--count-3 .risk dd{font-size:16px;margin-bottom:14px}.risks--count-4{grid-template-columns:repeat(2,minmax(0,1fr));grid-template-rows:repeat(2,minmax(0,1fr));height:500px}.risks--count-4 .risk{border-bottom:1px solid #d8e0e7;min-height:0;padding:22px 28px}.risks--count-4 .risk:nth-child(2n){border-right:0}.risks--count-4 .risk:nth-last-child(-n+2){border-bottom:0}.risks--count-4 .risk h2{font-size:21px}.risks--count-4 .risk dl{gap:5px;grid-template-columns:84px 1fr;margin-top:16px}.risks--count-4 .risk dt{font-size:12px}.risks--count-4 .risk dd{font-size:14px;line-height:1.25;margin-bottom:8px}.risks--count-4 .risk small{font-size:12px}.risks--count-3+.stop,.risks--count-4+.stop{margin-top:24px}
.decision-grid{border:1px solid #d8e0e7;border-radius:20px;box-shadow:0 18px 42px #1f334816;gap:0;overflow:hidden;position:relative}.decision-grid:before{background:linear-gradient(90deg,#2563eb,#6d5bd0);content:"";height:2px;left:0;position:absolute;right:0;top:0;z-index:1}.decision-main{border-radius:0}.decision-facts{background:#f8fafb;gap:0}.fact{border:0;border-bottom:1px solid #d8e0e7;padding:30px}.fact:last-child{border-bottom:0}.evaluation,.data-table{border:1px solid #d8e0e7;border-collapse:separate;border-radius:16px;border-spacing:0;overflow:hidden}.evaluation th,.data-table th{background:#e5eef7;border-bottom:1px solid #c7d6e3;color:#0b1020}.evidence-groups{border:1px solid #d8e0e7;border-radius:18px;box-shadow:0 14px 34px #1f334814;gap:0;grid-template-columns:repeat(2,1fr);overflow:hidden;position:relative}.evidence-groups:before{background:linear-gradient(90deg,#2563eb,#6d5bd0);content:"";height:2px;left:0;position:absolute;right:0;top:0;z-index:1}.evidence-group{border:0;border-bottom:1px solid #d8e0e7;border-right:1px solid #d8e0e7;min-height:180px;padding:30px}.evidence-group:nth-child(2n){border-right:0}.evidence-group:nth-last-child(-n+2){border-bottom:0}.controls{border:0;border-top:1px solid #c8d1d8;color:#4b5563;gap:18px;padding:14px 0 0}.timeline-decision{border:0;border-top:2px solid #6d5bd0;padding:22px 0 0;width:520px}
.cover-main{background:radial-gradient(circle at 104% 31%,transparent 0 150px,#2563eb66 151px 153px,transparent 154px),radial-gradient(circle at 94% 73%,transparent 0 108px,#6d5bd055 109px 111px,transparent 112px),var(--ink)}.cover-main:before{background:linear-gradient(#2563eb,#6d5bd0);width:4px}
...
@media(max-width:760px){.authority,.stop{padding:12px 0 0}.risk{padding:24px}}
@media(max-width:760px){.metrics,.responsibility,.risks{border-radius:14px}.metric,.responsibility-step,.risk{border-bottom:1px solid #d8e0e7;border-right:0}.metric:last-child,.responsibility-step:last-child,.risk:last-child{border-bottom:0}}
@media(max-width:760px){.decision-grid,.evidence-groups{border-radius:14px;grid-template-columns:1fr}.fact,.evidence-group{border-bottom:1px solid #d8e0e7;border-right:0}.fact:last-child,.evidence-group:last-child{border-bottom:0}.timeline-decision{width:auto}}
@media(max-width:760px){.risks--count-4{height:auto;grid-template-rows:none}.risks--count-4 .risk:nth-last-child(-n+2){border-bottom:1px solid #d8e0e7}.risks--count-4 .risk:last-child{border-bottom:0}}
`;
