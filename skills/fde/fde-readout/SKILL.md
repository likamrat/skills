...
5. **Separate audiences.** Customer and technical-handoff plans are external-audience boundaries. FDE leadership is internal. Each audience uses a distinct source plan.
...
4. customer and technical-handoff outputs mark every slide and referenced human-context entry customer-safe;
...
Do not produce a customer, technical-handoff, or leadership readout when:
...
- the plan mixes external and internal content;
